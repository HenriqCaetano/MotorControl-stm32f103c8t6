...
#define encoderChannelA_Pin GPIO_PIN_0
#define encoderChannelA_GPIO_Port GPIOA
#define encoderChannelB_Pin GPIO_PIN_1
#define encoderChannelB_GPIO_Port GPIOA
